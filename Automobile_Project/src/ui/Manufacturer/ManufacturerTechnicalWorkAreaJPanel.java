 ...
 */
public class ManufacturerTechnicalWorkAreaJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManufacturerTechnicalWorkAreaJPanel
     */
    JPanel workArea;
    EcoSystem system;
    UserAccount account;
    ...
    public ManufacturerTechnicalWorkAreaJPanel(JPanel workArea, UserAccount account,Organization organization,Enterprise enterprise , EcoSystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblWorkArea.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Order ID", "Model", "Quantity", "Manufacturer Technical", "Manufacturer Paint", "Status"
            }
        ) {
        ...
        jLabel1.setText("Manufacturing Technical Work Area");
    ...
    private void btnAssignActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignActionPerformed
        ...
        if(req.getManufacturerTechnical() != null){
        ...
        req.setManufacturerTechnical(account);
        req.setStatus("Manf. Technical assigned");
        populateRequestTable();
    ...
    private void btnManfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManfActionPerformed
        ...
        InventoryOrderRequest req = (InventoryOrderRequest)tblWorkArea.getValueAt(selectedRow, 0);
        if(req.getManufacturerTechnical() != account){
            JOptionPane.showMessageDialog(this, "It is not assigned to you!!", "Information", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        else if (req.getManufacturerTechnical() == account && req.getIsManf()==true && req.getIsPaint()==true && req.getIsTech()==false){
            req.setStatus("Manufactured Technical Done !!");
            req.setIsTech(true);
                    ...
                    for(Organization org: enterprise.getOrganizationDirectory().getOrganizationList()){
                        if(org.getName().equals(organization.getName())){
                            for(InventoryOrderRequest req : org.getInventoryOrderQueue().getInventoryOrderRequestList()){
                                    ...
                                    row[3] = req.getManufacturerTechnical()==null?"None":req.getManufacturerTechnical().getUsername();
                                    row[4] = req.getManufacturerPaint()==null?"None":req.getManufacturerPaint().getUsername();
                                    row[5] = req.getStatus();
